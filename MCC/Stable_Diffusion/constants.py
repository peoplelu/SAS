...
NUSCENES_DETAIL = ['person', 'bicycle', 'car', 'motorcycle', 'barricade', 'bus', 'bulldozer', 'excavator', 'crane', 'traffic cone', 'trailer', 'container', 'truck', 'road', 'pavement', 'grass', 'lawn', 'awning', 'building', 'wall', 'tree', 'plant', 'sky']
