...
def parse_args():
    ...
    parser.add_argument("--model-type", type=str, default='tap_vit_h', help="Model type")
    parser.add_argument("--checkpoint", type=str, default='models/tap_vit_h_v1_1.pkl', help="Model checkpoint")
    parser.add_argument("--concept", type=str, default='concepts/merged_2560.pkl', help="Concept weights")
